...
6. Apply + verify accepted fixes: `codewalk_accept_and_verify_fix(session_id)` returns the accepted findings — the host applies them with its own editing tools
7. Verify afterwards: `codewalk_run_static_analysis` + `codewalk_run_tests`
