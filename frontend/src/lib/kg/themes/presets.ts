import type { AccentSwatch, ThemePreset } from "./types";
...
export const PRESETS: ThemePreset[] = [
  {
    ...
    clusterColors: DARK_CLUSTER_COLORS,
    colors: {
      root: "#0a0a0a",
      surface: "#111111",
      elevated: "#1a1a1a",
  ...
  },
  {
    ...
    clusterColors: LIGHT_CLUSTER_COLORS,
    colors: {
      root: "#f5f3f0",
      surface: "#eae7e3",
      elevated: "#ffffff",
